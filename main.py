...
class tkinterApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for F in (LoginPage, RegisterPage, HomePage, Menu1Page, Menu2Page, Menu3Page, Menu4Page, Menu5Page,EncodePage):
...
class Menu1Page(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        #Coding button
        menu1_text = tk.StringVar()
        menu1_btn = tk.Button(self, command=lambda : controller.show_frame(EncodePage) , textvariable=menu1_text, font=("Anonymous Pro", 14), bg="#57B947",fg="black", width = 30)
...
class EncodePage(tk.Frame):
    ...
    def hash(self, input, out, out_text, type):
        ...
        if (type == "MD5"):
            ...
            base16INT= int(message, 16)
            print(hex(base16INT))
            out.config(text = hex(base16INT))
