...
class SymEncryptingMenu(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        menu1_btn = tk.Button(self, command=lambda : controller.show_frame(11) , textvariable=menu1_text, font=("Anonymous Pro", 14), bg="#57B947",fg="black", width = 30)
        menu1_text.set("Encrypt DES")
        menu1_btn.grid(column=0,row=1)

        #Decoding button
        menu2_text = tk.StringVar()
        menu2_btn = tk.Button(self, command=lambda : controller.show_frame(13) , textvariable=menu2_text, font=("Anonymous Pro", 14), bg="#57B947",fg="black", width = 30)
        menu2_text.set("Encrypt AES256")
        menu2_btn.grid(column=1,row=1)

        #Decoding button
        menu3_text = tk.StringVar()
        menu3_btn = tk.Button(self, command=lambda : controller.show_frame(12) , textvariable=menu3_text, font=("Anonymous Pro", 14), bg="#57B947",fg="black", width = 30)
        menu3_text.set("Decrypt DES")
        menu3_btn.grid(column=0,row=2)

        #Decoding button
        menu4_text = tk.StringVar()
        menu4_btn = tk.Button(self, command=lambda : controller.show_frame(14) , textvariable=menu4_text, font=("Anonymous Pro", 14), bg="#57B947",fg="black", width = 30)
